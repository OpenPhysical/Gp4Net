...
public class LuaVirtualCardService : ICardService
{
    ...
    public bool Connect(string readerName)
    {
        ...
        try
        {
            ...
            if (_parameters.Count > 0)
            {
                ...
                if (initFunc is { Type: DataType.Function })
                {
    ...
    public byte[]? GetAtr()
    {
        ...
        try
        {
            ...
            if (atrFunc is { Type: DataType.Function })
            {
    ...
    private static (string scriptPath, Dictionary<string, string> parameters) ParseLuaReaderName(string readerName)
    {
    ...
    private static string ResolveLuaScriptPath(string scriptPath)
    {
