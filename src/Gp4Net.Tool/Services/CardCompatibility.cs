...
/// </remarks>
[PublicAPI]
public class CardCompatibility
{
    private readonly ILogger<CardCompatibility> _logger;
    private readonly IEnvironmentValidation _environmentValidation;
    ...
    /// </returns>
    public static Result<CardCompatibility, SmartCardError> Create(
        ILogger<CardCompatibility> logger,
        IEnvironmentValidation environmentValidation
    )
    {
        return Maybe
            .From(logger)
            ...
            .Bind(validLogger =>
                Maybe
                    ...
                    .Map(validEnvValidation => new CardCompatibility(
                        validLogger,
                        validEnvValidation
                    ))
            );
