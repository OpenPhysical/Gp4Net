...
/// </summary>
public interface ICardSessionCommands : IDisposable
{
    /// <summary>
    ...
    /// </summary>
    ImmutablePipelineContext Context { get; }
    ...
    Result<ICardSessionCommands, SmartCardError> WithContext(ImmutablePipelineContext context);
    ...
    Result<ICardSessionCommands, SmartCardError> WithContextValue<T>(string key, T value);
...
public record SmartCardServiceOptions
{
    ...
    /// </summary>
    public ImmutablePipelineContext InitialContext { get; init; } = ImmutablePipelineContext.Empty;
}
