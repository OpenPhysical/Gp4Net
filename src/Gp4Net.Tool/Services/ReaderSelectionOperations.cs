...
/// </summary>
[PublicAPI]
public class ReaderSelectionOperations
{
    private readonly Func<Maybe<string>> readConfiguredReader;

    /// <summary>
    /// Initializes a new instance of the ReaderSelectionOperations class.
    /// </summary>
    /// <param name="readConfiguredReader">Reads the configured reader, when present.</param>
    public ReaderSelectionOperations(Func<Maybe<string>> readConfiguredReader)
    {
        this.readConfiguredReader = readConfiguredReader;
    }
    ...
    )
    {
        ...
        return await explicitReader.Match(
            ...
            async () =>
            {
                ...
                var envReader = readConfiguredReader();
    ...
    )
    {
        ...
        if (ReaderEnumeration.IsVirtualReader(readerSpec))
        {
    ...
    )
    {
        ...
        var readersWithMediaResult = await ReaderStatusOperations.GetReadersWithMediaAsync(
            cancellationToken
        );
