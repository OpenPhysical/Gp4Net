...
/// Consolidates VirtualCardConnections and PhysicalCardConnections into single entry point.
/// </summary>
/// <remarks>
...
/// </remarks>
[PublicAPI]
public static class CardConnections
{
    /// <summary>
    /// Creates a CardSessionCommands connection based on the connection specification.
    /// </summary>
    ...
    /// <returns>A CardSessionCommands connected to the specified card, or an error</returns>
    /// <remarks>
    ...
    /// </remarks>
    public static Task<Result<ICardSessionCommands, SmartCardError>> CreateConnectionAsync(
    ...
    /// <summary>
    /// Creates a virtual card connection using VirtualCardConnections.
    /// </summary>
    private static Task<Result<ICardSessionCommands, SmartCardError>> CreateVirtualConnection(
        string virtualSpec,
        ILogger<CardSessionCommands> logger,
        CancellationToken cancellationToken
    )
    {
        return VirtualCardConnections.CreateServiceAsync(virtualSpec, logger, cancellationToken);
    }

    /// <summary>
    /// Creates a physical card connection using PhysicalCardConnections.
    /// </summary>
    private static Task<Result<ICardSessionCommands, SmartCardError>> CreatePhysicalConnection(
        string readerName,
        ILogger<CardSessionCommands> logger,
        CancellationToken cancellationToken
    )
    {
        return PhysicalCardConnections.CreateServiceAsync(readerName, logger, cancellationToken);
    }
}
