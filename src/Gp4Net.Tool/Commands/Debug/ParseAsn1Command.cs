...
namespace Gp4Net.Tool.Commands.Debug
{
    ...
    public class ParseAsn1Command : IPipelineCommand<ParseAsn1Command.Settings>
    {
        ...
        private string GetLengthInfo(byte[] encoded)
        {
        ...
        private int GetHeaderLength(Asn1Object obj)
        {
            var encoded = obj.GetEncoded();
        ...
        private bool IsLikelyAsn1(byte[] data)
        {
            ...
            else
            {
                ...
                return lengthBytes > 0 && lengthBytes <= 4 && data.Length >= lengthBytes + 2;
            }
        }
    }
}