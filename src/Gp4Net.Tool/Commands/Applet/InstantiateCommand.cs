...
{
    /// <summary>
    /// Command to instantiate an applet from a loaded package.
    /// </summary>
    [PublicAPI]
    /// <summary>
    ...
    public class InstantiateCommand : BaseCommand<InstantiateCommand.Settings>
    {
        /// <summary>
        /// Initializes a new instance of the InstantiateCommand class.
        /// </summary>
        ...
        protected override Task<int> ExecuteCommandAsync(CommandContext context, Settings settings)
        {
            ...
            try
            {
                ...
                {
                    AnsiConsole.MarkupLine($"[dim]Instance AID: {settings.InstanceAid}[/]");
                }
                ...
                // TODO: Implement when GlobalPlatformService.InstallApplet is available
                ...
                if (settings.ShowSteps)
                {
                    ...
                    {
                        AnsiConsole.MarkupLine($"   - Parameters: {settings.InstallParams}");
                    }
            ...
            {
                AnsiConsole.MarkupLine($"[red]Error instantiating applet: {ex.Message}[/]");
                if (settings.Verbose)
                {
