...
namespace Gp4Net.Tool.Commands.Trace
{
    ...
    public class SimpleJsonConverter
    {
        ...
        private async Task<List<(string Command, string Response, int ResponseTime)>> ParseGpProTrace(string filename)
        {
        ...
        private string DetectOperationType(string description)
        {
        ...
        private void ExtractCardInfo(SimpleTraceData data, List<(string Command, string Response, int ResponseTime)> exchanges)
        {
