...
namespace Gp4Net.Tool.Scripting
{
    ...
    public class UtilityScriptModule
    {
        ...
        public byte[] Hex(string hexString)
        {
        ...
        /// </summary>
        [MoonSharpVisible(true)]
        public byte[] Sub(byte[] data, int start, int length)
        {
        ...
        /// </summary>
        [MoonSharpVisible(true)]
        public byte[] Pad80(byte[] data, int blockSize)
        {
        ...
        /// </summary>
        [MoonSharpVisible(true)]
        public byte[] IntToBytes(int value, int length)
        {
            var bytes = new byte[length];
