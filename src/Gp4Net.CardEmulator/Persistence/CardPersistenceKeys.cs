...
/// </summary>
[PublicAPI]
public class CardPersistenceKeys
{
    private readonly CounterModeKdf _kdf;

    /// <summary>
    /// Initializes a new instance of the CardPersistenceKeys class.
    /// </summary>
    public CardPersistenceKeys()
    {
    ...
    {
        return CryptoOperations.Hash.Sha256(data);
    }
