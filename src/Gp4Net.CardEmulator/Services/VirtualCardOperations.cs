...
/// </summary>
[PublicAPI]
public class VirtualCardOperations : IDisposable
{
    private readonly VirtualReaders _readerManager;
    private readonly Maybe<VirtualCardReader> _connectedReader;
    private readonly bool _disposed;

    /// <summary>
    /// Initializes a new instance of the VirtualCardOperations class.
    /// </summary>
    public VirtualCardOperations()
    {
        _readerManager = new VirtualReaders();
    ...
    public VirtualReaders GetReaderManager()
    {
        return _disposed
            ? new VirtualReaders() // Return empty manager if disposed
            : _readerManager;
    }
    ...
    public Result<bool, SmartCardError> Connect(string readerName)
    {
        ...
        return Maybe<string>
            ...
            .ToResult(Errors.EmptyArgument("Reader name"))
    ...
    public VirtualCardOperations WithConnectedReader(VirtualCardReader reader)
    {
        return new VirtualCardOperations(
            _readerManager,
    ...
    public VirtualCommandResponse SendCommand(byte[] command)
    {
        ...
        return Maybe<byte[]>
            ...
            .ToResult(Errors.EmptyArgument("Command"))
            .Bind(cmd =>
                _connectedReader
    ...
    /// </summary>
    public VirtualCardOperations Disconnect()
    {
        ...
        return new VirtualCardOperations(_readerManager, Maybe<VirtualCardReader>.None, false);
    }

    /// <summary>
    /// Creates a disposed version of this service.
    /// </summary>
    public VirtualCardOperations MarkDisposed()
    {
        var disconnectedService = Disconnect();
        return new VirtualCardOperations(new VirtualReaders(), Maybe<VirtualCardReader>.None, true);
    }
