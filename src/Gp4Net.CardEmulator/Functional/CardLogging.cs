...
/// </summary>
[PublicAPI]
public record CardLogging(Maybe<ILogger> Logger)
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a CardLogging from a non-null ILogger.
    /// </summary>
    public static CardLogging From(ILogger logger) => new(Maybe<ILogger>.From(logger));

    /// <summary>
    /// Creates a CardLogging with no logger (silent operation).
    /// </summary>
    public static CardLogging None => new(Maybe<ILogger>.None);
}
