...
/// Implements  interface and includes static methods for CLI operations.
/// </summary>
/// <remarks>
...
/// </remarks>
[PublicAPI]
public class CapFileOperations
{
    /// <summary>
    ...
    // ================================================================================================
    //  Implementation (extracted from VirtualCard CAP processing logic)
    // ================================================================================================
