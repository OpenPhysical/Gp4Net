...
/// </summary>
[PublicAPI]
public sealed class KeysetResolution
{
    /// <summary>
    ...
    public Result<IKeySet, SmartCardError> GetTestKeys(byte protocolVersion, byte keyVersion)
    {
        ...
        {
            0x02 => GpTestKeys.GetTestKeySet(CryptoOperations.ScpVersion.Scp02, keyVersion),
            0x03 => GpTestKeys.GetTestKeySet(CryptoOperations.ScpVersion.Scp03, keyVersion),
            _
    ...
    private static Result<IKeySet, SmartCardError> CreateKeyset(
        CryptoOperations.ScpVersion protocolVersion,
        byte[] encKey,
        byte[] macKey,
        byte[] dekKey,
        byte keyVersion
