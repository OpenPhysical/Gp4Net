    ...
    public static class Applications
    {
        ...
        )
        {
            ...
            return response.IsSuccess
                ? Responses.ParseGetStatusResponse(response.Value)
        ...
        )
        {
            ...
            // Parse response and convert to ExecutableLoadFile objects
            Result<ImmutableList<ApplicationInfo>, SmartCardError> parseResult =
                Responses.ParseGetStatusResponse(response.Value);
