...
namespace Gp4Net.Services
{
    ...
    public class FunctionalSmartCardServiceFactory : ISmartCardServiceFactory
    {
        ...
        private async Task<Result<ICardContext, SmartCardError>> CreateCardContextAsync()
        {
        ...
        private CardProtocol DetectProtocol(ILegacyCardChannel channel)
        {
        ...
        private IApduTransport CreateTransport(ICardChannel channel, CardProtocol protocol)
        {
            ...
            return protocol switch
            {
                ...
                CardProtocol.TCL => new TClApduTransport(
                    Microsoft.Extensions.Logging.Abstractions.NullLogger<TClApduTransport>.Instance,
