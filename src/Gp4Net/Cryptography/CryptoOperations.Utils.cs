...
public static partial class CryptoOperations
{
    ...
    public static class Utils
    {
        ...
        /// Delegates to CryptoOperations.Rng for consistent random generation.
        /// Supports both secure (production) and deterministic (testing) modes.
        /// This method is deprecated - use CryptoOperations.Rng.GenerateBytes() directly.
        /// </summary>
        /// <param name="length">Number of bytes to generate.</param>
        /// <returns>Array of random bytes or error.</returns>
        [Obsolete("Use CryptoOperations.Rng.GenerateBytes() directly")]
