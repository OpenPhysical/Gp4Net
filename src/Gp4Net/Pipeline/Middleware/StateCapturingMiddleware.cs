...
public class StateCapturingMiddleware : CommandMiddlewareBase
{
    ...
    private static IPipelineContext CaptureInitializeUpdateState(
        CommandResponse response,
        IPipelineContext context)
    {
    ...
    private static IPipelineContext CaptureGetStatusState(
        CommandResponse response,
        IPipelineContext context)
    {
        if (!response.IsSuccess || response.Data.Length == 0)
    ...
    private static IPipelineContext CaptureGetDataState(
