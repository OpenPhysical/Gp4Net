...
public interface ISecureChannelProtocol
{
    ...
    Result<Security.SecureChannelState, SmartCardError> CreateSecureChannelSession(
        SecureChannelContext context,
        SecurityLevel securityLevel
    );
}
...
public interface ISecureChannelManager
{
    ...
    /// <returns>A result containing the established secure channel state or an error.</returns>
    Task<Result<Security.SecureChannelState, SmartCardError>> EstablishAsync(
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>A result containing the established secure channel state or an error.</returns>
    Task<Result<Security.SecureChannelState, SmartCardError>> EstablishAutoDetectAsync(
        ICardChannel channel,
        IApduTransport transport,
        IKeySet keySet,
        SecurityLevel securityLevel,
