...
public sealed class Scp02ProtocolService : IScpProtocolService<Scp02ProtocolService>
{
    ...
    /// <inheritdoc />
    public static int MacSize => 8; // Full MAC (not truncated in SCP02)
        ...
        byte[] chainingValue)
    {
        ...
        return CryptographicOperations.Calculate3DesMac(macKey, macInput);
    }
        ...
        byte[] chainingValue)
    {
        ...
        return CryptographicOperations.Calculate3DesMac(rMacKey, macInput);
    }
