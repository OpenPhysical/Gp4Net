...
public class Scp02IcvEncryptionTests
{
    ...
    public void Scp02_Should_Use_First_Half_Of_CMac_Key_For_ICV_Encryption()
    {
        ...
        byte[] expectedFirstHalf = [.. cMacSessionKey.Take(8)];
        ...
        _ = extractedKey
            .Length.Should()
            .Be(8, "ICV encryption key should be 8 bytes (first half of C-MAC key)");
        _ = extractedKey
            .Should()
            .BeEquivalentTo(
                expectedFirstHalf,
        ...
        byte[] secondHalf = [.. cMacSessionKey.Skip(8).Take(8)];
        _ = extractedKey
            .Should()
            .NotBeEquivalentTo(
                secondHalf,
    ...
    public void Scp02_Should_Encrypt_ICV_Before_Subsequent_CMac_Calculations()
    {
        ...
        _ = subsequentIcvResult
            .IsSuccess.Should()
            .BeTrue("Subsequent ICV processing should succeed");
    ...
    public void Scp02_Should_Not_Encrypt_ICV_For_Non_Encryption_Implementations(
        ScpImplementation implementation
    )
    {
        // Arrange
        _ = implementation
            .HasIcvEncryption()
            .Should()
            .BeFalse("Test should only include non-ICV-encryption implementations");
