...
namespace Gp4Net.Tests.Domain.Commands
{
    ...
    public class InstallCommandTests
    {
        ...
        #region InstallForLoadCommand Tests
        ...
        public void InstallForLoadCommand_Create_WithValidPackageAid_ReturnsSuccess()
        {
            ...
            command.PackageAid.Should().Equal(_validPackageAid);
        ...
        public void InstallForLoadCommand_Create_WithAllOptionalParameters_ReturnsSuccess()
        {
            ...
            command.Type.Should().Be(InstallType.ForLoad);
            command.PackageAid.Should().Equal(_validPackageAid);
            command.SecurityDomainAid.Should().Equal(_validSecurityDomainAid);
            command.Hash.Should().Equal(_validHash);
            command.InstallToken.Should().Equal(_validInstallToken);
            ...
            command.LoadParameters.Should().Equal(expectedLoadParams);
        }
        ...
        {
            var result = InstallCommand.InstallForLoadCommand.Create(Array.Empty<byte>());
        ...
        public void InstallForLoadCommand_Data_WithMinimalParameters_BuildsCorrectStructure()
        {
            ...
            data.Skip(1).Take(_validPackageAid.Length).Should().Equal(_validPackageAid);
        ...
        public void InstallForLoadCommand_Data_WithAllParameters_BuildsCorrectStructure()
        {
            ...
            offset++;
            data.Skip(offset).Take(_validPackageAid.Length).Should().Equal(_validPackageAid);
            offset += _validPackageAid.Length;
            
            // Security Domain AID
            data[offset].Should().Be((byte)_validSecurityDomainAid.Length);
            offset++;
            data.Skip(offset).Take(_validSecurityDomainAid.Length).Should().Equal(_validSecurityDomainAid);
            offset += _validSecurityDomainAid.Length;
            
            // Hash
            data[offset].Should().Be((byte)_validHash.Length);
            offset++;
            data.Skip(offset).Take(_validHash.Length).Should().Equal(_validHash);
            ...
            data.Skip(offset).Take(4).Should().Equal(expectedLoadParams);
            offset += 4;
            
            // Install Token
            data[offset].Should().Be((byte)_validInstallToken.Length);
            offset++;
            data.Skip(offset).Take(_validInstallToken.Length).Should().Equal(_validInstallToken);
        }
        ...
        public void InstallForLoadCommand_ToApdu_GeneratesCorrectApdu()
        {
            ...
            apdu.Skip(5).Take(command.Data.Length).Should().Equal(command.Data);
        ...
        #region InstallForInstallCommand Tests
        ...
        public void InstallForInstallCommand_Create_WithValidParameters_ReturnsSuccess()
        {
            ...
            command.PackageAid.Should().Equal(_validPackageAid);
            command.ModuleAid.Should().Equal(_validModuleAid);
            command.AppletAid.Should().Equal(_validAppletAid);
            command.Privileges.Should().Equal(_validPrivileges);
        ...
        public void InstallForInstallCommand_Create_WithAllOptionalParameters_ReturnsSuccess()
        {
            ...
            result.IsSuccess.Should().BeTrue();
            var command = result.Value;
            command.InstallParameters.Should().Equal(_validInstallParameters);
            command.InstallToken.Should().Equal(_validInstallToken);
        }
        ...
        public void InstallForInstallCommand_Create_WithEmptyPrivileges_UsesDefaultPrivileges()
        {
            ...
            result.IsSuccess.Should().BeTrue();
            var command = result.Value;
            command.Privileges.Should().Equal(new byte[] { 0x00 }); // Default privileges
        }
        ...
        public void InstallForInstallCommand_Data_WithMinimalParameters_BuildsCorrectStructure()
        {
            ...
            offset++;
            data.Skip(offset).Take(_validModuleAid.Length).Should().Equal(_validModuleAid);
            offset += _validModuleAid.Length;
            
            // Applet AID
            data[offset].Should().Be((byte)_validAppletAid.Length);
            offset++;
            data.Skip(offset).Take(_validAppletAid.Length).Should().Equal(_validAppletAid);
            offset += _validAppletAid.Length;
            
            // Privileges
            data[offset].Should().Be((byte)_validPrivileges.Length);
            offset++;
            data.Skip(offset).Take(_validPrivileges.Length).Should().Equal(_validPrivileges);
        ...
        public void InstallForInstallCommand_Data_WithAllParameters_BuildsCorrectStructure()
        {
            ...
            offset++;
            data.Skip(offset).Take(_validInstallParameters.Length).Should().Equal(_validInstallParameters);
        ...
        #region InstallCommandBuilder Tests
        ...
        public void InstallCommandBuilder_CreateForInstall_WithNullModuleAid_UsesPackageAid()
        {
            ...
            result.IsSuccess.Should().BeTrue();
            var command = result.Value;
            command.ModuleAid.Should().Equal(_validPackageAid); // Should use package AID
            command.Privileges.Should().Equal(new byte[] { 0x00 }); // Default privileges
        }
        ...
        #region InstallCommandResponse Tests
        ...
        public void InstallCommandResponse_Success_WithData_CreatesSuccessResponse()
        {
            ...
            response.IsSuccess.Should().BeTrue();
            response.StatusWord.Should().Be(0x9000);
            response.Data.Should().Equal(responseData);
        }
        ...
        public void InstallCommand_IsImmutable_PropertiesCannotBeModified()
        {
            ...
            command.PackageAid.Should().Equal(originalPackageAid);
        ...
        public void InstallForInstallCommand_WithLongAids_HandlesCorrectly()
        {
            ...
            result.IsSuccess.Should().BeTrue();
            var command = result.Value;
            command.PackageAid.Should().Equal(longAid);
            command.ModuleAid.Should().Equal(longAid);
            command.AppletAid.Should().Equal(longAid);
        ...
        public void InstallForInstallCommand_WithComplexPrivileges_HandlesCorrectly()
        {
            ...
            result.IsSuccess.Should().BeTrue();
            var command = result.Value;
            command.Privileges.Should().Equal(complexPrivileges);
        }
        ...
        public void InstallForLoadCommand_Create_PreservesInputArrays()
        {
            ...
            result.IsSuccess.Should().BeTrue();
            result.Value.PackageAid.Should().Equal(originalPackageAid);
        }
        ...
        public void InstallForInstallCommand_Create_PreservesInputArrays()
        {
            ...
            var command = result.Value;
            command.PackageAid.Should().Equal(originalPackageAid);
            command.ModuleAid.Should().Equal(originalModuleAid);
            command.AppletAid.Should().Equal(originalAppletAid);
            command.Privileges.Should().Equal(originalPrivileges);
        }
