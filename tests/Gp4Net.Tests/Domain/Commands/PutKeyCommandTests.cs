...
namespace Gp4Net.Tests.Domain.Commands
{
    ...
    public class PutKeyCommandTests
    {
        ...
        #region Key Usage Qualifier Tests
        ...
        #region Key Encryption Key Identifier Tests
        ...
        #region KeyDataBlock Creation Tests - DES Keys
        ...
        public void CreateDesKey_WithValidKeyValue_ReturnsSuccessResult()
        {
            ...
            keyDataBlock.Value.Should().Equal(ValidDesKey);
        ...
        public void CreateDesKey_WithValidKeyValueAndCheckValue_ReturnsSuccessResult()
        {
            ...
            keyDataBlock.Length.Should().Be(8);
            keyDataBlock.Value.Should().Equal(ValidDesKey);
            keyDataBlock.KeyCheckValue.Should().Equal(ValidKeyCheckValue);
        }
        ...
        #region KeyDataBlock Creation Tests - 3DES Keys
        ...
        public void CreateTripleDes2Key_WithValidKeyValue_ReturnsSuccessResult()
        {
            ...
            keyDataBlock.Value.Should().Equal(ValidTripleDes2Key);
            keyDataBlock.KeyCheckValue.Should().BeNull();
        }
        ...
        public void CreateTripleDes3Key_WithValidKeyValue_ReturnsSuccessResult()
        {
            ...
            keyDataBlock.Value.Should().Equal(ValidTripleDes3Key);
            keyDataBlock.KeyCheckValue.Should().BeNull();
        }
        ...
        #region KeyDataBlock Creation Tests - AES Keys
        ...
        public void CreateAes128Key_WithValidKeyValue_ReturnsSuccessResult()
        {
            ...
            keyDataBlock.Length.Should().Be(16);
            keyDataBlock.Value.Should().Equal(ValidAes128Key);
            keyDataBlock.KeyCheckValue.Should().BeNull();
        }
        ...
        public void CreateAes192Key_WithValidKeyValue_ReturnsSuccessResult()
        {
            ...
            keyDataBlock.Length.Should().Be(24);
            keyDataBlock.Value.Should().Equal(ValidAes192Key);
            keyDataBlock.KeyCheckValue.Should().BeNull();
        }
        ...
        public void CreateAes256Key_WithValidKeyValue_ReturnsSuccessResult()
        {
            ...
            keyDataBlock.Value.Should().Equal(ValidAes256Key);
            keyDataBlock.KeyCheckValue.Should().BeNull();
        }
        ...
        #region KeyDataBlock Creation Tests - RSA and ECC Keys (Not Yet Implemented)
        ...
        #region KeyDataBlock Type Tests
        ...
        #region KeyDataBlock ToBytes Tests
        ...
        public void ToBytes_WithoutKeyCheckValue_ReturnsCorrectBytes()
        {
            ...
            bytes.Skip(2).Take(8).Should().Equal(ValidDesKey);
        }
        ...
        public void ToBytes_WithKeyCheckValue_ReturnsCorrectBytes()
        {
            ...
            bytes[1].Should().Be(0x08); // Key length
            bytes.Skip(2).Take(8).Should().Equal(ValidDesKey);
            bytes.Skip(10).Take(3).Should().Equal(ValidKeyCheckValue);
        }
        ...
        public void PutKeyCommand_KeyDataBlocks_ReturnsImmutableCollection()
        {
            ...
            command.KeyDataBlocks.Should().Equal(keyDataBlocks);
        }
        ...
        public void ToApdu_WithSingleKey_ReturnsCorrectApduStructure()
        {
            ...
            apdu.Skip(7).Take(8).Should().Equal(ValidDesKey); // Key data
        ...
        public void ToApdu_WithMultipleKeys_ReturnsCorrectApduStructure()
        {
            ...
            apdu.Skip(17).Take(16).Should().Equal(ValidAes128Key); // Key data
        ...
        public void ToApdu_WithKeyCheckValue_IncludesCheckValueInData()
        {
            ...
            apdu.Skip(7).Take(8).Should().Equal(ValidDesKey); // Key data
            apdu.Skip(15).Take(3).Should().Equal(ValidKeyCheckValue); // Key check value
        ...
        public void Data_WithValidKeyDataBlocks_ReturnsCorrectData()
        {
            ...
            data.Skip(2).Take(8).Should().Equal(ValidDesKey);
        }

        #endregion

        #region PutKeyResponse Tests
        ...
        public void PutKeyResponse_Parse_WithValidResponse_ReturnsSuccessResult()
        {
            ...
            response.KeyCheckValues[0].Should().Equal(Convert.FromHexString("123456"));
            response.KeyCheckValues[1].Should().Equal(Convert.FromHexString("789ABC"));
        }
        ...
        public void ToApdu_WithLargeKeyData_HandlesCorrectly()
        {
            ...
            keyData.Should().Equal(ValidAes256Key);
            
            // Verify KCV
            var kcvData = apdu.Skip(keyDataStart + 2 + 32).Take(3).ToArray();
            kcvData.Should().Equal(ValidKeyCheckValue);
        }
