...
using CardCapabilities = Gp4Net.Domain.CardInfo.CardCapabilities;
...
public class CardDiscoveryCapabilityTests
{
    ...
    public void CardData_P71_ParsesCorrectly()
    {
        ...
        const int configDetailsStart = 4; // After tag 0x73 and length 0x4B
    ...
    public void CardDiscovery_UnsupportedFeatures_HandledGracefully()
    {
        ...
        byte[] unsupportedStatus = [0x69, 0x82]; // Command not allowed / function not supported
    ...
    public void CardData_OidParsing_IdentifiesProtocolSupport()
    {
        ...
        int secondOidOffset = contextTagOffset + 2;
