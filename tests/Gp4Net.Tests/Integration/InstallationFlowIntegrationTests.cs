...
public class InstallationFlowIntegrationTests
{
    ...
    public static class OpenFips201InstallationTrace
    {
        ...
        public static readonly byte[] StaticKeyEnc = Convert.FromHexString("404142434445464748494A4B4C4D4E4F");
        public static readonly byte[] StaticKeyMac = Convert.FromHexString("404142434445464748494A4B4C4D4E4F");
        public static readonly byte[] StaticKeyDek = Convert.FromHexString("404142434445464748494A4B4C4D4E4F");
        ...
        public static readonly byte[] ExpectedSEnc = Convert.FromHexString("8F68D7056FE602D97FF70BFA36D87961");
        public static readonly byte[] ExpectedSMac = Convert.FromHexString("AA133569FEC01F8D1BDA168939E90C2E");
        public static readonly byte[] ExpectedSRMac = Convert.FromHexString("05B237DF134CD46B7B13DF0BF9EAE35D");

        // Installation Flow Commands
        public static readonly byte[] InitializeUpdateCommand = Convert.FromHexString("80500000086140423CDFBD163800");
        public static readonly byte[] InitializeUpdateResponse = Convert.FromHexString("03700000000000000000010370D9DB42088EC157E73482F0E96DBF633B0000419000");

        public static readonly byte[] ExternalAuthenticateCommand = Convert.FromHexString("848201001005527F7CFB17ECD2B596B1DFB99B480F");
        ...
        public static readonly string SHA256 = "da7243300d1f08622a102bfefc40b3f6c86d010aa1fa45efd9e31a0b34b8f959";

        // Installation Commands
        public static readonly byte[] InstallForLoadCommand = Convert.FromHexString("84E602001E09A0000003080000100008A000000151000000000000CE95E7B51EF7F878");
        ...
        public static readonly byte[] FirstLoadCommand = Convert.FromHexString("");
    ...
    public void InstallationFlow_OpenFips201_SCP03_ParsesCommands_Successfully()
    {
        ...
        Result<InitializeUpdateCommand, SmartCardError> initUpdateCmd = InitializeUpdateCommand.CreateWithOptions(
            keyVersion: 0x00,
            keyIdentifier: 0x00,
        ...
        byte[] responseData = OpenFips201InstallationTrace.InitializeUpdateResponse.Take(
            OpenFips201InstallationTrace.InitializeUpdateResponse.Length - 2).ToArray(); // Remove SW1SW2
        Result<InitializeUpdateResponse, SmartCardError> parsedResponseResult = InitializeUpdateResponse.Parse(responseData);
