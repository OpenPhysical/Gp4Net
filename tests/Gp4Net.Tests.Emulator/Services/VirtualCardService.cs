...
namespace Gp4Net.Tests.Emulator.Services
{
    /// <summary>
    ...
    public class VirtualCardService
    {
        ...
        /// </summary>
        public bool IsSecureChannelEstablished => _connectedReader?.InsertedCard?.IsSecureChannelEstablished == true;
        ...
        /// <summary>
        /// Adds a virtual reader with an ACOS JavaCard for testing.
        /// </summary>
        /// <param name="readerName">The name for the virtual reader.</param>
        /// <returns>The virtual reader.</returns>
        public VirtualCardReader AddVirtualAcosReader(string readerName = "Virtual ACOS Reader 00 00")
        {
            var reader = new VirtualCardReader(readerName);
            var acosCard = new Cards.AcosJavaCard();
            
            reader.InsertCard(acosCard);
        ...
        public void SetupTestEnvironment()
        {
            ...
            // Add ACOS JavaCard reader
            AddVirtualAcosReader("Virtual ACOS Reader 00 00");
            
            // Add another reader for multi-reader testing
            var reader2 = new VirtualCardReader("Virtual Test Reader 01 00");
            var acosCard2 = new Cards.AcosJavaCard();
            reader2.InsertCard(acosCard2);
